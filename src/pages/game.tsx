...
const allDiseases = [
  // Canditral (Product 0)
  { id: 1, name: "Onychomycosis", image: "/dieseses/1.1.png", productId: 0, width: 500, height: 96 },
  { id: 2, name: "Tinea capitis", image: "/dieseses/1.2.png", productId: 0, width: 160, height: 96 },
  { id: 3, name: "Tinea corporis", image: "/dieseses/1.3.png", productId: 0, width: 500, height: 96 },
  // Keto Plus (Product 4)
  ...
  { id: 8, name: "Inflammatory acne", image: "/dieseses/3.2.png", productId: 2, width: 500, height: 96 },
  // Fisoativ (Product 3)
  { id: 9, name: "Xerosis", image: "/dieseses/4.1.png", productId: 3, width:2000, height:966 },
  { id: 10, name: "Adjuvant therapy in Eczema", image: "/dieseses/4.2.png", productId: 3, width:500, height: 96 },
  // Tacroz (Product 1)
  { id: 11, name: "Atopic dermatitis", image: "/dieseses/5.1.png", productId: 1, width: 500, height: 96 },// 
  { id: 12, name: "Steroid sparing agent", image: "/dieseses/5.2.png", productId: 1, width:500, height:96 },
  // Momate (Product 5)
            ...
            {currentDiseases.map((disease) => (
              <div
                ...
                className={`
                  ...
                  ${draggedDisease?.id === disease.id ? 'scale-110 rotate-3' : 'hover:scale-105'}
                `}
              >
